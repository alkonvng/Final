...
var mongoose = require('mongoose'),
    ...
    artCtrl = require('./articles.server.controller.js'),
	_ = require('lodash');
...
exports.firstCreate = function(req, res) {
    var name = 'Mi primer blog';
    var blog = new Blog({name:' Mi primer blog' + req.user._doc.displayName});
    blog.user = req.user;
    req.blog = blog;
    artCtrl.firstCreate(req,res);
